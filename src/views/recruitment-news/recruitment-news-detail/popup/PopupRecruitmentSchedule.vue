...
import { CandidateScheduleDetailModel, CandidateScheduleModel, RecruitmentBroadModel, RecruitmentDetailModel } from "../../../../models";
 ...
 const props = withDefaults(defineProps<{
    isShowPopup: boolean
    selectedRecruitmentDetail: RecruitmentDetailModel[]
...
if(props.recruitmentID){
    candidateSchedule.value.RecruitmentID = props.recruitmentID
}

if(props.selectedRecruitmentDetail && props.selectedRecruitmentDetail.length){
    props.selectedRecruitmentDetail.forEach((item) => {
        handleAddCandidate(item)
    })
}

if(props.recruitmentBroads && props.recruitmentBroads.length){
    candidateSchedule.value.RecruitmentBroads = props.recruitmentBroads
}
...
getRecruitmentBroad(props.recruitmentID)
